...
* Se modifico el codigo para obtener los factores de uso como (Fu/(ϕ*Fn)*100 en %, de donde se obtuvo que las barras sometidas a mayores esfuerzos fueron las horizontales (azules), con las barras superiores sometidas a un maximo de 26.11% y las inferiores a un maximo de 81.62%, ambos maximos coincidiendo con el medio del puente.
